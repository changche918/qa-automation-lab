...
for i in range(3):
    try:
        ...
        avatar = finder.visit_elem(By.CLASS_NAME, "figure")
        ...
        user_name_element = finder.visit_elem(By.CSS_SELECTOR, ".figcaption h5")
        ...
        view_profile_text = finder.visit_elem(By.LINK_TEXT, "View profile")
        ...
        if view_profile_text.text == 'View profile':
            ...
            new_page = finder.visit_elem(By.TAG_NAME, "h1")
