...
# 將寫死 log 路徑寫法替代成以下寫法
# Path(__file__) 目前檔案位置，.resolve() = 絕對路徑，parent = 上一層資料夾
...
# 20260331 調整 log 路徑寫法，增加無頭模式，增加選擇執行模式 PR #12
...
def main():
    ...
    if choice == "1":
        finder.scan_first_high_gp_post()
    elif choice == "2":
        finder.scan_each_high_gp_post()
    else:
        print("輸入無效，請輸入 1 或 2。")

    # finder.scan_first_high_gp_post()
    titles, best_art_elem = finder.scan_first_high_gp_post()
