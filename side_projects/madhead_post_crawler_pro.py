...
# log 路徑寫法 (2) 20260404 不用拆太細
project = "madhead"
log_dir = "side_projects/logs"
file_extension = "log.txt"

file_path = f"{log_dir}/{project}_post_{file_extension}"
content_path = f"{log_dir}/{project}_content_{file_extension}"
