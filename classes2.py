...
print(person_john)
# print([person_john]) #TODO(2/2): repr vs str
...
"""
# TODO(2/2): 自行寫繼承範例
# 1. 有無super().__init__使用function (L63)
# 2. 使用super().xxx
# 3. function or init覆蓋後呼叫父類別的範例
# 4. 無使用L61(Person) or L63(super().__init__(name, age)) 呼叫父類別方法的差異 (可搭配1和2嘗試)
"""
...
# TODO(2/2): 範例 2: Rectangle 與 Square（示範繼承與 super()）
class Rectangle:
